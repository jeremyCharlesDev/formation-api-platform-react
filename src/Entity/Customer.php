 ...
 *     itemOperations={"GET"={"path"="/customers/{id}"}, "PUT", "DELETE", "PATCH"},
 ...
 *      },
 * )
 * @ApiFilter(SearchFilter::class, properties={"firstName" : "start", "lastName", "company"} )
...
class Customer
{
    ...
    /**
     * Permet de récupérer le total des invoices pour un customer
     * @Groups({"customers_read"})
     * @return float
     */
    ...
    /**
     * Permet de récupérer le montant total non payé (hors factures payées ou annulées)
     * @Groups({"customers_read"})
     * @return float
     */
